...
{
    use ApiTestTrait, DatabaseMigrations;
    ...
    public function test_create_package()
    {
        ...
        $this->assertArrayHasKey('_id', $createdPackage);
        $this->assertNotNull($createdPackage['_id'], 'Created Package must have id specified');
        $this->assertNotNull(Package::find($createdPackage['_id']), 'Package with given id must be in DB');
